...
export default function WorkExperienceItem({ item, index, showLine, isLast }: WorkExperienceItemProps) {
  return (
    <TimelineItem
      index={index}
      showLine={showLine}
      lineGradient="bg-gradient-to-b from-blue-500/50 via-purple-500/30 to-transparent group-hover:from-blue-400 group-hover:via-purple-400 transition-all duration-500"
      dotGradient="bg-gradient-to-br from-blue-500 to-purple-600"
      pingGradient="bg-gradient-to-br from-blue-400 to-purple-500"
      glowGradient="bg-gradient-to-r from-blue-400/0 via-purple-400/0 to-cyan-400/0 group-hover:from-blue-400/10 group-hover:via-purple-400/10 group-hover:to-cyan-400/10"
    >

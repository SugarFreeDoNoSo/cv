...
export default function EducationItem({
  ...
  return (
    <TimelineItem
      index={index}
      showLine={showLine}
      lineGradient="bg-gradient-to-b from-emerald-500/50 via-teal-500/30 to-transparent   transition-all duration-500"
      dotGradient="bg-gradient-to-br from-emerald-500 to-teal-600"
      pingGradient="bg-gradient-to-br from-emerald-400 to-teal-500"
      glowGradient="bg-gradient-to-r from-emerald-400/0 via-teal-400/0 to-cyan-400/0   "
    >
      {/* Glass morphism background */}
      <div className="relative bg-adaptive rounded-2xl p-8 transition-all duration-500 shadow-2xl  ">
        {/* Decorative background elements */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 rounded-full blur-3xl opacity-50  transition-opacity duration-700"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-cyan-500/5 to-blue-500/5 rounded-full blur-2xl opacity-30  transition-opacity duration-700"></div>
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              {/* Decorative icon */}
              <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg    transition-all duration-300">
                <svg
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 h-px bg-gradient-to-r from-emerald-400/60 via-teal-400/60 to-cyan-400/60 opacity-0  transition-opacity duration-500"></div>
          </div>
          ...
          {item.description && (
            <div className="space-y-4">
              ...
              <div className="group/desc  p-4 rounded-lg transition-all duration-300 border border-transparent ">
                <p className="text-adaptive leading-relaxed hover/desc:text-adaptive-heading transition-colors duration-300">
                  {item.description}
                </p>
              </div>
            </div>
        ...
        {/* Hover glow effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/0 via-teal-400/0 to-cyan-400/0    rounded-2xl opacity-0  transition-all duration-700 pointer-events-none"></div>
      </div>
    </TimelineItem>
  );
}

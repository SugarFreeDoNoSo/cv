...
export default function EducationItem({ item, index, showLine }: EducationItemProps) {
  return (
    <TimelineItem
      index={index}
      showLine={showLine}
      lineGradient="bg-gradient-to-b from-emerald-500/50 via-teal-500/30 to-transparent group-hover:from-emerald-400 group-hover:via-teal-400 transition-all duration-500"
      dotGradient="bg-gradient-to-br from-emerald-500 to-teal-600"
      pingGradient="bg-gradient-to-br from-emerald-400 to-teal-500"
      glowGradient="bg-gradient-to-r from-emerald-400/0 via-teal-400/0 to-cyan-400/0 group-hover:from-emerald-400/10 group-hover:via-teal-400/10 group-hover:to-cyan-400/10"
    >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30">
                        ...
                        <span className="text-xs font-medium text-adaptive-accent">Completado</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 text-adaptive">
                  ...
                  {item.location && (
                    <>
                      <span className="hidden sm:inline text-adaptive-accent">•</span>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-adaptive">{item.location}</span>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-400/30">
                  ...
                  <span className="text-xs font-medium text-adaptive-accent">Licenciatura</span>
                </div>
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-purple-400/30">
                  ...
                  <span className="text-xs font-medium text-adaptive-accent">Ciencias de la Computación</span>
                </div>
              </div>
            </div>
